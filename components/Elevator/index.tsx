...
const Elevator = ({text1, text2, color}:ElevatorInterface) => {
  return (
    <div className={`${styles.elevator} ${color === 'white' && styles.white}`}>
        <Container className={styles.container}>
            <div className={styles.elevatorInner}>
                <div className={styles.elevatorText}>
                    <p>{text1}</p>
                    {text2 && (
                            <p>{text2}</p>
                    )}
                </div>
                <svg height="800px" width="800px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"  xmlSpace="preserve" className={styles.elevatorSvg}>
                    <style type="text/css">
                        {`.st0{fill:#000000;}`}
                    </style>
                    <g>
                        <path className="st0" d="M190.922,219.894c-11.799,0-21.355,9.556-21.355,21.348c0,11.782,9.556,21.339,21.355,21.339
                            c11.783,0,21.34-9.557,21.34-21.339C212.261,229.451,202.704,219.894,190.922,219.894z"/>
                        <path className="st0" d="M321.095,219.894c-11.783,0-21.348,9.556-21.348,21.348c0,11.782,9.565,21.339,21.348,21.339
                            c11.79,0,21.347-9.557,21.347-21.339C342.442,229.451,332.885,219.894,321.095,219.894z"/>
                        <path className="st0" d="M395.775,134.779H116.226c-21.485,0-38.961,17.476-38.961,38.96v299.3c0,21.485,17.476,38.961,38.961,38.961
                            ...
                            V473.039z"/>
                        <path className="st0" d="M286.457,70.744l29.21-29.21v65.672c0,5.992,4.855,10.848,10.846,10.848c5.992,0,10.847-4.855,10.847-10.848
                            ...
                            C275.351,74.978,282.223,74.978,286.457,70.744z"/>
                        <path className="st0" d="M182.881,114.875l7.67,7.67l7.67-7.67l47.736-47.736c4.234-4.234,4.234-11.105,0-15.339
                            ...
                            l-29.21-29.21c-4.234-4.234-11.105-4.234-15.348,0c-4.234,4.234-4.234,11.105,0,15.339L182.881,114.875z"/>
                    </g>
                </svg>
            </div>
        </Container>
