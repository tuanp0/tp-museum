...
const MusicPlayer: React.FC = () => {
  ...
  return (
    <div className={`${styles.musicplayer} ${isOpened && styles.show}`} onMouseLeave={() => setIsOpened(false)}>
      <button className={styles.musicplayerBtn} onClick={() => setIsOpened(!isOpened)} />
